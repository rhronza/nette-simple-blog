<?php
// source: C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/config/config.neon 
// source: C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/config/config.local.neon 

class Container_9932f00498 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\ArticleManager' => [1 => ['28_App_Model_ArticleManager']],
		...
		'services' => [
			...
			'28_App_Model_ArticleManager' => 'App\Model\ArticleManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app',
			'wwwDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/../temp',
		];
	}
	...
	public function createService__28_App_Model_ArticleManager(): App\Model\ArticleManager
	{
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('28_App_Model_ArticleManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=nette-simple-blog',
			'srvcmn', 'TaModZFqmudCkVMC', ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_9932f00498 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\Roman Hronza\OneDrive\Php\htdocs\nette-simple-blog\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\SimpleAuthenticator([
			'roman' => 'hronza',
			'saturnin' => 'passSaturnin',
			'maruška' => 'karasova',
		], ['roman' => null, 'saturnin' => null, 'maruška' => null]);
		return $service;
	}
